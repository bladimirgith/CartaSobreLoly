...
let para = "Loly"; // valor por defecto
let mensaje = `Mi princesa hermosa hay tantas cosas bonitas que quiero decirte porque sin duda tú mereces todo lo bonito del mundo🥹
Estuve pensando qué hice para conocer una persona tan linda como tú.
cada vez que me llega una llamada tuya, me pone muy contento aunque hablemos todo el día, tu serás siempre mi persona favorita, me gusta todo de ti , eres una persona maravillosa increíble y no quiero que dejes que alguien te diga lo contrario.❤️🥰🥹Gracias por hacerme la persona más feliz del mundo no sé cómo describir lo que siento por ti, un simple te " TE AMO " no es suficiente. 
Te prometo hacerte la persona más feliz del universo como tú lo haces conmigo gracias por aparecer en mi vida!!!!!!! .
eres la persona  más importante en este mundo, estoy orgulloso de ti y todo lo que logras.
Te quiero TE AMO ❤️`;
...
let loadingText = "Para ti Loly"; // valor por defecto para loading
